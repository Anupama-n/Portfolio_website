          ...
          <div className="space-y-6">
            ...
            <div>
              <input
                ...
                className="w-full px-6 py-4 rounded-full border-2 transition-all focus:outline-none"
                style={{
                ...
                onBlur={(e) => {
                  e.target.style.borderColor = 'rgba(45, 45, 45, 0.1)';
            ...
            <div>
              <textarea
                ...
                onChange={handleInputChange}
                rows={6}
                className="w-full px-6 py-4 rounded-3xl border-2 transition-all focus:outline-none resize-none"
                style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.7)',
                  borderColor: 'rgba(45, 45, 45, 0.1)',
                  color: '#2d2d2d',
