                ...
                >
                  <div className="flex flex-col gap-4 lg:gap-5">
                    ...
                    <div className="space-y-2 lg:space-y-3">
                      <h5 className="text-sm lg:text-base font-semibold text-gray-800 mb-2 lg:mb-3">Key Contributions & Methodology:</h5>
                      {displayedHighlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-start gap-2 lg:gap-3">
                          <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-blue-400 rounded-full mt-1.5 lg:mt-2 flex-shrink-0"></div>
                          <p className="text-gray-700 text-xs lg:text-sm leading-relaxed">
                            {highlight}
                          </p>
                        </div>
...
<div className="lg:hidden">
  <button
    ...
    className="flex items-center gap-1 mt-3 px-3 py-1 border border-gray-800 rounded-md text-sm text-gray-800 font-medium hover:bg-gray-100 transition-colors duration-200"
  >
    {isExpanded ? (
      <>
        <span>Show Less</span>
      ...
      <>
        ...
        <ChevronDown className="w-4 h-4" />
                      ...
                      <div className="hidden lg:block">
                        {researchProject.highlights.slice(3).map((highlight, idx) => (
                          <div key={idx + 3} className="flex items-start gap-2 lg:gap-3">
                            <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 bg-blue-400 rounded-full mt-1.5 lg:mt-2 flex-shrink-0"></div>
                            <p className="text-gray-700 text-xs lg:text-sm leading-relaxed">
                              {highlight}
                            </p>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 p-3 lg:p-4 rounded-lg mt-3 lg:mt-4">
                      <p className="text-blue-800 text-xs lg:text-sm font-medium italic leading-relaxed">
