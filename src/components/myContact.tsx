...
import { GraduationCap, Phone, Mail, MapPin, Instagram, Github, Trophy, FileText, ChevronDown, ChevronUp, Linkedin } from 'lucide-react'
                      ...
                      >
                        <div className="flex flex-col gap-1 lg:gap-3">
                          <div>
                            ...
                            <p className="text-gray-600 text-xs lg:text-base leading-snug">
                              {edu.institution}
                            </p>
                            {edu.board && (
                        ...
                        {contact.link ? (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-xs lg:text-base text-gray-800 font-medium leading-tight">{contact.value}</p>
                            </div>
                          </a>
                        ) : (
                    ...
                    >
                      <div className="flex flex-col gap-2 lg:gap-4">
                        <div>
                          ...
                          <p className="text-gray-600 text-xs lg:text-lg font-medium">
