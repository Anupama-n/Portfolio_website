...
return (
  <motion.section
    id="about"
    className="relative w-full min-h-screen flex items-center justify-center overflow-hidden py-12 lg:py-24"
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20 items-center">
        ...
        <motion.div
          ...
          className="relative mx-auto w-full max-w-[180px] sm:max-w-xs lg:max-w-md"
          whileHover={{ scale: 1.015, y: -4 }}
          transition={{ duration: 0.5, ease: "easeOut" }}
        >
          <div className="relative aspect-[3.5/4] rounded-sm group">
            <div
              className="absolute -top-3 -left-3 lg:-top-6 lg:-left-6 w-full h-full border border-opacity-20 rounded-sm"
            ...
            >
              <Layers className="w-4 h-4 lg:w-5 lg:h-5" style={{ color: COLORS.gold }} />
            </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-col justify-center text-left space-y-3 lg:space-y-6"
        >
          {/* Tagline */}
          <motion.div variants={itemVariants} className="flex items-center gap-2 lg:gap-3">
            <span className="h-px w-4 lg:w-8" style={{ background: COLORS.gold }} />
            <span
...
>
  ...
  <span
    className="italic"
    style={{ color: COLORS.roseSoft, fontFamily: "'Passions Conflict', cursive" }}
  >
    Intuitive
  </span>{"    "}
  & <br />
  <span
    className="italic"
    style={{ color: COLORS.goldLight, fontFamily: "'Passions Conflict', cursive" }}
  >
    Impactful
  </span>{"    "}
  Experiences
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              "I bridge the gap between user needs and business goals, transforming complex problems into elegant, accessible digital solutions."
            </p>
          </motion.div>
          ...
          <motion.p
            variants={itemVariants}
            className="text-xs md:text-base leading-relaxed opacity-80 max-w-lg"
            style={{ color: COLORS.cream, fontFamily: "'Raleway', sans-serif" }}
          >
            With a background in cognitive psychology and visual arts, I bring a unique
            perspective to product design. My process is data-driven yet human-centric,
            ensuring every interaction is meaningful. From chaotic wireframes to
            pixel-perfect prototypes, I love every step of the journey.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="pt-2 lg:pt-4">
            ...
            <div className="flex flex-wrap gap-x-1.5 gap-y-1.5 lg:gap-y-2 lg:gap-x-2">
              {skills.map((skill) => (
                <motion.div
                  key={skill}
                  whileHover={{
